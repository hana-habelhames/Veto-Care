...
import { Heart, PawPrint, Phone, MapPin, Building2, X } from "lucide-react";
            ...
            <div key={l.id} className="bg-card rounded-2xl border border-brand-border overflow-hidden shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all">
              ...
              <div className="p-4">
                ...
                <button
                  ...
                  className="mt-3 w-full inline-flex items-center justify-center gap-2 rounded-xl bg-brand-accent text-brand-accent-foreground text-sm font-semibold px-3 py-2.5 hover:opacity-90 transition"
                >
                  <Phone className="h-4 w-4" /> Contacter le vétérinaire
                </button>
              </div>
            </div>
          ))}
